...
class StartGame:
    ...
    def __init__(self):
        ...
        self.greek_roman_quiz_select = Radiobutton(self.entry_area_frame, text="Greek / Roman", variable=v, value="1", indicator=0,
                                                   font=("Arial", "20", "bold"), width=15, height=1, bg="#FF9999", fg="#FFFFFF")

        self.greek_roman_quiz_select.grid(row=1, column=0, padx=10, pady=10)

        self.god_name_quiz_select = Radiobutton(self.entry_area_frame, font=("Arial", "20", "bold"), variable=v, value="2", indicator=0,
                                                text="God Name", width=15, bg="#96C5F7", fg="#FFFFFF")
