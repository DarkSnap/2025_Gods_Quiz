...
class StartQuiz:
    ...
    def __init__(self):
        ...
        self.mixed_quiz_select = Radiobutton(self.quiztype_area_frame, font=("Arial", "20", "bold"),
                                                ...
                                                bg="#97F79C", fg="#ffffff", selectcolor="#bbd8fa")
    ...
    def __init__(self, how_many, quiz_type):
        ...
        for i in range(4):
            gods_button = Button(self.gods_name_frame, font=("Arial", 12, "bold"),
                                 ...
                                 bg=button_colors[i], fg="#ffffff", disabledforeground="#404040",
...
class Stats:
    ...
    def __init__(self, partner, all_stats_info):
        ...
        success_rate = rounds_won / self.rounds_played * 100
        ...
        # Get height needed for all results
        results_height = self.rounds_played * 45

        # Create canvas
        canvas = Canvas(self.stats_frame, width=450, height=300,
                        scrollregion=(0, 0, 400, results_height))
        canvas.grid(row=4, column=0)

        # Add scrollbar when needed
        if results_height > 300:
            scrollbar = Scrollbar(self.stats_frame, orient=VERTICAL, command=canvas.yview)
        ...
        for i in range(self.rounds_played):
            label = Label(results_frame, text=f"Round: {round_number[i]} | Result: {user_scores[i]}",
                          font=("Courier", 12), justify="left", wraplength=400, padx=25)
            label.pack(anchor="w")
