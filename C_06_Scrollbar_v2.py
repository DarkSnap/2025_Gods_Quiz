...
class Stats:
    ...
    def __init__(self, partner, all_stats_info):
        ...
        # Canvas
        canvas = Canvas(self.stats_frame, width=260, height=300, scrollregion=(0, 0, 0, 2400))
        ...
        for i in range(rounds_played):
            label = Label(canvas, text=f"Round: {round_number[i]} | Result: {user_scores[i]}", font=("Courier", 12), compound=RIGHT)
