...
class StartGame:
    ...
    def __init__(self):
        ...
        self.greek_roman_quiz_select = Radiobutton(self.entry_area_frame, font=("Arial", "20", "bold"), variable=self.game_type,
        ...
        self.god_name_quiz_select = Radiobutton(self.entry_area_frame, font=("Arial", "20", "bold"), variable=self.game_type,
...
class Play:
    ...
    def __init__(self, how_many, game_type):
        ...
        if game_type == 1:
            ...
            self.game_type_label = Label(self.game_frame, text="Greek / Roman",
                                         font=("Arial", "16", "bold"))
            ...
            self.game_type_label = Label(self.game_frame, text="Gods Quiz",
                                         font=("Arial", "16", "bold"))
            self.game_type_label.grid(row=0)
